...
import com.logistics.Components.Shipment;
...
public class CLI {
    ...
    private static Transport transportMenu() {
        try {
            ...
            switch (option) {
                case 1: {
                    AirTransport t = new AirTransport();
                ...
                case 2: {
                    LandTransport t = new LandTransport();
                ...
                case 3: {
                    SeaTransport t = new SeaTransport();
        ...
        try{
            switch (option) {
                ...
                case 3: // ---------- Change Transport
                    Transport tempTransport = new Transport(shipment.getTransport());
