...
public:
    ...
    virtual void copyToProto(PBStockItem* message){}; // Blank to be filled by child class
    virtual void copyFromProto(const PBStockItem& message){}; // Blank to be filled by child class
protected:
    float cost;
    std::string name;
    std::string supplier;
